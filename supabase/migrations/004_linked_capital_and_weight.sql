-- Linked Capital + weight: goals with a cost link to a Capital asset; optional weight tracking (Vitality)
...
comment on column public.assets.linked_capital_asset_id is 'When set: Capital asset that tracks money for this goal (e.g. course fees, medical)';
